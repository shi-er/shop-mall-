package com.li.yun.biao.client.cache;
...
public class CacheService {
    ...
    public List<UserMenuVo> getUserMenu(Integer uid) {
        return usPermissionService.getUserMenuVoByUid(uid, PermissionMenuType.VUE.type);
    }

    @Cacheable(value = "permissionCache", key = "#uid", unless = "#result == null")
    public List<String> getPermCodes(Integer uid) {
        return usPermissionService.getPermCode(uid, PermissionMenuType.VUE.type);
    }
