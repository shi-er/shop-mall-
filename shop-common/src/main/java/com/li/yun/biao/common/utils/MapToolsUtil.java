...
public class MapToolsUtil {
     ...
     * @return
     */
    public static AtlasModel getAddress(String ingLat) {
     ...
     * @return 地址详细
     */
    public static AtlasModel getAddressByGaoDe(String ingLat) {
     ...
     * @throws IOException
     */
    public static AtlasModel getAddressByIp(String ip) {
     ...
     * @param ip     null
     */
    public static AtlasModel getAddressBylngLatOrIp(String lngLat, String ip) {
        if (StringUtil.isNotBlank(lngLat)) {
            AtlasModel atlasModel = getAddress(lngLat);
        ...
        if (StringUtil.isNotBlank(ip) && RegexUtils.checkIpAddress(ip)) {
            AtlasModel atlasModel = getAddressByIp(ip);
            if (!Objects.isNull(atlasModel) && StringUtil.isNotBlank(atlasModel.getProvince())
                    && StringUtil.isNotBlank(atlasModel.getCity())) {
